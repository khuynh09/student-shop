                ...
                <div className="profile">
                    ...
                    <div className="bio">
                        <h3 className="bio-text">
                            Hi, everyone 👋🏼! My name is Melissa 🛼, and I'm
                            currently a third year at UC Irvine 💙💛 majoring in
                            Psychology. Thanks for checking out my page! I do
                            both worldwide 🌎 and local shipping 📍. DM me for
                            any questions! 🍄
                        </h3>
                    </div>
                    <div className="listings">
                        ...
                        <img
                            ...
                            src="https://i.pinimg.com/originals/d1/29/47/d12947612508acc731392e1ee29ad8f0.jpg"
                            onClick={() => {
                                history.push("/listing/1");
                            }}
                            alt="Melissa's listing"
                            style={{
                                height: "350px",
                                objectFit: "cover",
                            }}
